      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Test Series Details</h1>
              <p className="text-gray-600 mt-1">Manage tests in this series</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  {seriesDetails.description || "No description provided for this test series."}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600">Manage and view all tests in this series</p>
          </div>
          <button
        ...
        {tests.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">This test series doesn't have any tests yet. Create your first test to get started.</p>
            <button
