      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            {/* Form Header */}
            <div className="px-8 py-6 border-b border-slate-200 bg-gradient-to-r from-emerald-50 to-teal-50">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 placeholder-gray-500 resize-none"
                      placeholder="Enter your question here. Be clear and specific..."
                    />
                    <p className="text-xs text-gray-500">
                      Write a clear and concise question that students can
                      easily understand
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {formData.options.map((opt, index) => (
                      <div key={index} className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          className="flex-1 px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 placeholder-gray-500"
                    ...
                    <button
                      type="button"
                      onClick={addOption}
                      className="inline-flex items-center gap-2 px-4 py-2 text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors font-medium"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 placeholder-gray-500"
                        placeholder="Enter the exact correct option text"
                      />
                    </div>
                    <p className="text-xs text-gray-500">
                      Enter the exact text of the correct option as it appears
                      above
                    </p>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 appearance-none bg-white"
                        >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>
                    • Write clear, unambiguous question text that students can
                    easily understand
                  </li>
                  <li>
                    • Ensure all options are plausible but only one is
                    definitively correct
                  </li>
                  <li>
                    • Use the exact text from options when specifying the
                    correct answer
                  </li>
                  <li>
                    • Provide explanations to help students learn from their
                    mistakes
                  </li>
                  <li>
                    • Set appropriate marks and difficulty levels for balanced
                    assessment
                  </li>
                </ul>
              </div>
