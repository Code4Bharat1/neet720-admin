  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.error("chemistry meta fetch failed:", err);
        setLoading(false);
      }
    })();
  }, []);
                    ...
                    <td className="py-4 px-4 text-left font-Mulish font-semibold text-black">
                      <div className="flex items-center">
                        <div className="p-1 bg-purple-100 rounded-full mr-2">
                          <Image src="/placeholder.svg?height=20&width=20" alt="Chemistry" width={20} height={20} className="w-5 h-5" />
                        </div>
                                        ...
                                        <td className="py-3 px-4 text-center">
                                          <div className="font-Mulish font-semibold flex items-center justify-center space-x-1">
                                            <div className="p-1 bg-purple-100 rounded-full">
                                              <Image src="/placeholder.svg?height=16&width=16" alt="Chemistry" width={16} height={16} className="w-4 h-4" />
                                            </div>
