  ...
  const mainFeatures = [
    {
      id: 'preview',
      title: 'Test Preview',
      description: 'Preview and review your tests before publishing to ensure quality',
      icon: Eye,
      color: 'amber',
      route: '/test_preview',
      stats: '12 drafts'
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Create, manage, and schedule tests with our comprehensive testing platform designed for educators
          </p>
        </section>
                ...
                >
                  <div className="flex flex-col h-full">
                    <div className="flex items-start justify-between mb-4">
                      <div className={`w-14 h-14 ${colors.bg} ${colors.hover} rounded-2xl flex items-center justify-center transition-colors group-hover:scale-110 transition-transform duration-200`}>
                    ...
                    <div className="mt-4 flex items-center text-sm text-blue-600 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
                      Get started <ArrowLeft size={16} className="ml-1 rotate-180" />
                    </div>
                  </div>
                </div>
              );
