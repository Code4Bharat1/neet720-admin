...
const Page = () => {
      ...
      if (token) {
        try {
          ...
          const response = await axios.post(
            `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/batchesInfobyId`,
            { admin_id: adminId }
          );
  ...
  const fetchNotices = async (adminId) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/fetch-notice`,
        { adminId }
      );
  ...
  const uniqueBatches = [
    ...new Set(notices.map((notice) => notice.batchName).filter(Boolean)),
  ];
    ...
    <div className="flex">
      ...
      <div className="flex-1">
        ...
        <div className="p-6 md:ml-20 max-w-7xl mx-auto ml-10 max-md:ml-0 max-md:max-w-full max-sm:p-2 max-sm:mt-20">
          ...
          <div className="mb-8">
            <div className="flex flex-col items-center text-center mb-4">
              ...
              <p className="text-gray-600 mt-1">
                Create, manage and organize notices for your batches
              </p>
              <button
          ...
          {/* Notices List */}
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-6 w-full max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl mx-auto">
            ...
            {loading ? (
              <div className="p-12 text-center">
                <svg
                  className="animate-spin w-8 h-8 mx-auto mb-4 text-blue-600"
                  fill="none"
                  viewBox="0 0 24 24"
                >
                  <circle
                  ...
                  >
                    {editNoticeId === notice.id ? (
                      ...
                      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                            <div className="flex items-center gap-1">
                              ...
                              <span>
                                End: {formatDate(notice.noticeEndDate)}
                              </span>
                            </div>
                            {notice.batchName && (
                              <div className="flex items-center gap-1">
                        ...
                        <div className="flex gap-2 mt-4 md:mt-0 md:flex-col md:items-end">
                          <button
