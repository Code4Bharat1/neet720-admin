                        ...
                        {filteredStudents.length > 0 ? (
                          filteredStudents.map((student) => (
                            <tr key={student.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4">{student.emailAddress}</td>
                              <td className="px-6 py-4">{student.mobileNumber}</td>
                              <td className="px-6 py-4">{student.domicileState || "—"}</td>
                              <td className="px-6 py-4">{batchData.batchId}</td>
                            </tr>
                          ))
                        ) : (
                          <tr>
                          ...
                          filteredTests.map((test, index) => {
                            ...
                            return (
                              <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">{test.no_of_questions}</td>
                                <td className="px-6 py-4">{formatDate(test.exam_start_date)}</td>
                                <td className="px-6 py-4">{formatDate(test.exam_end_date)}</td>
